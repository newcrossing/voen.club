$(document).ready(function () {
    ...
    $("#category").change(function () {
        if ($(this).val() == 1) {
            $("#category-help").text("военнослужащие подразделений специального назначения, разведывательных, воздушно-десантных, десантно-штурмовых и морской пехоты");
        } else if ($(this).val() == 2) {
            $("#category-help").text("личный состав основных подразделений и подразделений боевого обеспечения (кроме указанных в категории N 1) воинских частей видов (родов войск) Вооруженных Сил, управления соединений, воинских частей; слушатели и курсанты вузов");
        } else if ($(this).val() == 3) {
            $("#category-help").text("военнослужащие подразделений материального, технического и медицинского обеспечения, ремонта и обслуживания, соединений (бригад) надводных кораблей и подводных лодок, военных оркестров, переменный состав учебных воинских частей (военнослужащие по контракту - курсанты). Военнослужащие, проходящие военную службу в органах военного управления (от управления объединения и выше), в организациях Вооруженных Сил");
        }
    });
